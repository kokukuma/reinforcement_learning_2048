...
# mkdir -p result/episodes_fixed_learn/1/
# mkdir -p result/episodes_fixed_learn/10/
...
# 学習回数10固定.
# python pybrain_rl_simple2.py -p ./result/episodes_fixed_learn/1/ -e 1 -t 10
# python pybrain_rl_simple2.py -p ./result/episodes_fixed_learn/10/ -e 10 -t 100
# python pybrain_rl_simple2.py -p ./result/episodes_fixed_learn/50/ -e 50 -t 500
